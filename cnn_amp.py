...
def train_cnn(train_set, test_set, exp_name):
    ...
    checkpoint_filepath = f'results/cnn1d_models/cnn1d_ampspectra_{exp_name}.h5'
    ...
    with open(f'results/cnn1d_models/cnn1d_ampspectra_{exp_name}_metrics.json', 'w') as f:
        json.dump(metrics, f)
