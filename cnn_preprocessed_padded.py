...
from data_utils import prepare_data, shuffle_data, normalize_min_max_v2
...
def train_cnn(train_set, test_set, exp_name):
    ...
    checkpoint_filepath = f'results/cnn1d_models/cnn1d_preprocessed_padded_{exp_name}.h5'
    ...
    for epoch in range(500):
        ...
        history = model.fit(
            X_train, y_train, epochs=1, batch_size=40, verbose=0,
    ...
    with open(f'results/cnn1d_models/cnn1d_preprocessed_padded_{exp_name}_metrics.json', 'w') as f:
        json.dump(metrics, f)
